...
class Controller
{
	...
	public function letNumCheck($value): string | bool
    {
	...
	public function alphaCheck($value): string | bool
    {
		$value = urldecode($value); // Changable //
	...
	public function passCheck($value): string | bool
    {
		$value = trim($value);
	...
	public function mailCheck($value): string | bool
    {
		$value = trim($value);
	...
	public function smtpMail($mailConfig, $mailDetails, $mailReceiver): void
    {
	...
	// VERIFY FILE FORMAT // IMAGE TYPES //
 	public function checkImage($fileType, $fileSize, $fileError): int
    {
	...
	public function agentCheck(): string
    {
	...
	public function ipCheck(): string
    {
