<div class="sidebar-wrapper sidebar-theme">
    <nav id="sidebar">
        <div class="navbar-nav theme-brand flex-row  text-center">
            <div class="nav-logo">
                <div class="nav-item theme-logo">
                    <a href="/">
                        <img src="public/assets/src/assets/img/logo.svg" class="navbar-logo" alt="logo">
                    </a>
                </div>
        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            ...
            <li class="menu">
                <a href="add-client.php" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="contact" data-bs-parent="#accordionExample">
                    <li class="active">
                        <a href="add-contact-group.php"> Groups </a>
                    </li>
                    <li class="">
                        <a href="add-contacts.php"> Contacts </a>
                    </li>
                </ul>
            </li>

            <li class="menu">
                <a href="#campaign" data-bs-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-phone"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path></svg>
                ...
                <ul class="collapse submenu list-unstyled" id="campaign" data-bs-parent="#accordionExample">
                    <li class="active">
                        <a href="add-campaign.php"> Create Campaign </a>
                    </li>
                    <li class="">
                        <a href="list-campaign.php"> Campaign List </a>
                    </li>
                </ul>
            </li>
        </ul>
